  ...
  <!-- curso-->
   ...
   <div class="container">
      <div class="row">
        ...
        <h1 class="text-right"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Administración <small>Cursos</small></h1>
      </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <ul class="nav nav-tabs" >
              <li class="active"><a href="#new" data-toggle="tab">Nuevo </a></li>&nbsp;&nbsp
