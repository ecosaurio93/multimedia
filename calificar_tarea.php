...
//$id_curso=$_SESSION['id_curse'];
  ...
  $result=mysqli_query($link,"select  * from tarea where id_tarea='$id_tarea' ");
...
echo( "Fecha de publicacion: "."$fecha");
echo "</div>";
echo "</div>";
echo "<br>";
echo "<br>";
...
echo ('<form id="contact-form" method="post" action="calificar_tarea2.php? dato=$id_c" role="form">

      <div class="col-md-2">
                <div class="form-group">
                    <label for="calificacion">CALIFICACION </label>
                    <input id="calificacion" type="text" name="calificacion" class="form-control" placeholder="Calificacion*" required="required" data-error="debe llenar este campo">
...
<br>
    ...
    <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="comentario" type="text" name="comentario" class="form-control" placeholder="agregue comentario" required="required" data-error="debe llenar este campo">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
