...
*/
  ...
  $result=mysqli_query($link,"select  * from tarea where id_contenido='$id_contenido'");
...
echo '<table class="table table-hover table-dark">
   <thead>
    <tr>
    <td scope="col">N°</td>
      <td scope="col">NOMBRE DEL ALUMNO</td>
...
$fecha= $row['fecha'];
 $nombre_alumno= $row['nombre_alumno'];
    $result3 =mysqli_query($link,"select  * from cal_tarea where id_tarea='$id'");
...
if($cal==NULL){
  ...
  echo " <tr><td>$i</td><td>$nombre_alumno</td><td>$tarea</td><td>$fecha</td> 
<td><a href='calificar_tarea.php?dato=$id'>Calificar</a></td></tr>";
